...
`,Ar=`<div class="modal__background"></div>
...
`,Ir=Object.freeze(Object.defineProperty({__proto__:null,Button:Cr,ChatItem:wr,ChatsList:Mr,Input:Pr,Message:Er,ModalControlUser:xr,ModalLoadPhoto:Ar},Symbol.toStringTag,{value:"Module"})),Or=`<nav>
    <ul>
...
`,Nr=`<div class="wrapper">
    <div class="chat__nav">
        ...
        <div class="chat__nav-header">
            ...
            {{>Input name="nav-search" appointment="input__nav-search" type="text" label="Поиск"}}
        </div>
        {{>ChatsList}}
    </div>
...
`,Dr=`<div class="wrapper">
    <div class="chat__nav">
        ...
        <div class="chat__nav-header">
            {{>Button appointment="nav-profile" label="Профиль"}}
            {{>Input name="nav-search" appointment="input__nav-search" type="text" label="Поиск" defaultValue="Кино"}}
        </div>
...
`,Vr=`<form class="form">
    <div class="form-data">
        ...
        {{> Input name="login-login" label="Логин" type="text" appointment="input__form" error="Неверный логин"}}
        {{> Input name="login-password" label="Пароль" type="password" appointment="input__form"}}
...
`,Wr=`<div class="wrapper">
    ...
    <div class="profile__field">
        ...
        <div class="profile__data">
            <p>Старый пароль</p>
            {{>Input name="profile-old-password" appointment="input__profile-data" type="password" label="******"}}
        </div>
        <div class="profile__data">
            <p>Новый пароль</p>
            {{>Input name="profile-new-password" appointment="input__profile-data" type="password" label="********"}}
        </div>
        <div class="profile__data">
            <p>Повторите новый пароль</p>
            {{>Input name="profile-confirm-password" appointment="input__profile-data" type="password" label="********"}}
        </div>
...
`,zr={nav:[Or],chat:[Nr],chatAddRemoveUser:[Br],chatFunctions:[Rr],chatSearch:[Dr],chatSelect:[Hr],dialogLoad:[Ur],error404:[qr],error500:[Tr],login:[Vr],profile:[Fr],profileChangeData:[Gr],profileChangePassword:[Wr],profileLoadAvatar:[jr],signIn:[Kr]};Object.entries(Ir).forEach(([e,t])=>{yt.registerPartial(e,t)});function St(e){const[t,o]=zr[e],h=document.getElementById("app");h.innerHTML=yt.compile(t)(o)}document.addEventListener("DOMContentLoaded",()=>St("nav"));document.addEventListener("click",e=>{const t=e.target.getAttribute("page");t&&(St(t),e.preventDefault(),e.stopImmediatePropagation())});
